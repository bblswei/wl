...
public class TypeDescriptor implements Serializable {
	...
	private static final boolean streamAvailable = ClassUtils.isPresent("java.util.stream.Stream",
			TypeDescriptor.class.getClassLoader());
	...
	private static final Class<?>[] CACHED_COMMON_TYPES = { boolean.class, Boolean.class, byte.class, Byte.class,
			char.class, Character.class, double.class, Double.class, int.class, Integer.class, long.class, Long.class,
	 ...
	 * <p>
	 * Use this constructor when a source or target conversion point is a property
	 * on a Java class.
	 * 
	 * @param property
	 *            the property
	 ...
	 * constructor is used internally and may also be used by subclasses that
	 ...
	 *            a descriptor for the collection's element type, used to convert
	 *            collection elements
	 ...
	 * @param nestingLevel
	 *            the nesting level of the collection/array element or map key/value
	 *            declaration within the method parameter
	 * @return the nested type descriptor at the specified nesting level, or
	 *         {@code null} if it could not be obtained
	 * @throws IllegalArgumentException
	 *             if the nesting level of the input {@link MethodParameter}
	 *             argument is not 1, or if the types up to the specified nesting
	 ...
	 * <p>
	 * For example, if the property is a {@code List<String>} and the nesting level
	 * is 1, the nested type descriptor will be {@code String.class}.
	 * <p>
	 * If the property is a {@code List<List<String>>} and the nesting level is 2,
	 * the nested type descriptor will also be a {@code String.class}.
	 * <p>
	 * If the property is a {@code Map<Integer, String>} and the nesting level is 1,
	 * the nested type descriptor will be String, derived from the map value.
	 * <p>
	 * If the property is a {@code List<Map<Integer, String>>} and the nesting level
	 * is 2, the nested type descriptor will be String, derived from the map value.
	 * <p>
	 * Returns {@code null} if a nested type cannot be obtained because it was not
