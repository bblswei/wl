...
public abstract class CallbackHelper implements CallbackFilter {
	...
	protected abstract Object getCallback(Method arg0);
	...
	public Class[] getCallbackTypes() {
		return this.callbacks.size() == 0
				? new Class[0]
				: (this.callbacks.get(0) instanceof Callback
						? ReflectUtils.getClasses(this.getCallbacks())
						: (Class[]) ((Class[]) this.callbacks.toArray(new Class[this.callbacks.size()])));
	}
	...
	public boolean equals(Object o) {
		return o == null
				? false
				: (!(o instanceof CallbackHelper) ? false : this.methodMap.equals(((CallbackHelper) o).methodMap));
	}
}