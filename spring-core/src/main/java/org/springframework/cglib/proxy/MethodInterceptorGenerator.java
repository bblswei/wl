...
import org.springframework.cglib.proxy.MethodInterceptorGenerator.1;
import org.springframework.cglib.proxy.MethodInterceptorGenerator.2;
...
class MethodInterceptorGenerator implements CallbackGenerator {
	...
	private static final Type METHOD_INTERCEPTOR = TypeUtils
			.parseType("org.springframework.cglib.proxy.MethodInterceptor");
	...
	public void generateFindProxy(ClassEmitter ce, Map sigMap) {
      CodeEmitter e = ce.begin_method(9, FIND_PROXY, (Type[])null);
      e.load_arg(0);
      e.invoke_virtual(Constants.TYPE_OBJECT, TO_STRING);
      2 callback = new 2(this, e, sigMap);
