...
import org.springframework.cglib.transform.impl.InterceptFieldTransformer.1;
...
public class InterceptFieldTransformer extends ClassEmitterTransformer {
	...
	private static final Type CALLBACK = TypeUtils
			.parseType("org.springframework.cglib.transform.impl.InterceptFieldCallback");
	private static final Type ENABLED = TypeUtils
			.parseType("org.springframework.cglib.transform.impl.InterceptFieldEnabled");
	...
	public CodeEmitter begin_method(int access, Signature sig, Type[] exceptions) {
      return new 1(this, super.begin_method(access, sig, exceptions));
   }
