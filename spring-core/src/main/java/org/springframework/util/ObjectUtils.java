...
public abstract class ObjectUtils {
	...
	/**
	 * Check whether the given exception is compatible with the specified exception
	 * types, as declared in a throws clause.
	 * 
	 * @param ex
	 ...
	 * 
	 * @param array
	 *            the array to check (may be {@code null}, in which case the return
